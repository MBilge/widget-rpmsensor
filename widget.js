...
cprequire_test(["inline:com-chilipeppr-widget-rpmsensor"], function(myWidget) {
...
cpdefine("inline:com-chilipeppr-widget-rpmsensor", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-widget-rpmsensor", // Make the id the same as the cpdefine id
